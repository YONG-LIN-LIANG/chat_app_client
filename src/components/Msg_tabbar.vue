...
<template>
    ...
    <div v-show="tabList.active === 3" class="tabbar_func">
      <div class="tabbar_func_content">
        ...
        <div class="cate_group_wrap w-full mx-0 my-5">
          <transition name="slideY" class="overflow-hidden">
            <div>
              <div
  ...
  <ul
    class="tabbar_section w-16 min-w-16 flex flex-col items-center bg-gray-7 pt-5 tabbar_section--xs"
  >
