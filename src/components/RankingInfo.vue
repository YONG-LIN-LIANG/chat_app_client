...
<template>
	...
	>
		...
		<div class="ranking_star_wrap flex items-center mr-5">
			...
			<div class="ranking_average w-6 text-center text-green-Default mr-1">{{ rateItem.averageRating }}</div>
		</div>
	...
	<transition name="swipe">
		<div v-show="rateItem.showDetail" class="w-62 h-105 relative overflow-hidden">
			...
			>
				...
				>
					<div class="ranking_star_wrap flex items-center mr-5">
						<div class="ranking_average text-green-Default mr-1">{{ ratingPer.rating }}</div>
