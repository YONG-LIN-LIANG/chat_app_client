...
<template>
	<div
		:class="[
			...
			chatEnd_closed ? 'opacity-0 pointer-events-none' : 'opacity-100 pointer-events-auto',
		]"
	>
		...
		>
			...
			<div class="btn_wrap flex justify-center sm:flex-col">
				<div class="btn_secondary-orange m-2" @click="handleToggleDialog"> 返回對話 </div>
				<div class="btn_primary--orange m-2" @click="handleToggleDialog"> 結束對話 </div>
			</div>
		</div>
	</div>
</template>
