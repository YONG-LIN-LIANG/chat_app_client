    ...
    <div class="w-full px-6 flex lg:flex-col lg:items-center">
      <div class="score_container w-80">
        ...
        <div class="search_filter_section px-10 py-3">
          <div
            class="search_filter_title h-10 flex items-center justify-between"
          >
          ...
          <p class="text-green-b50 my-4 text-center cursor-pointer">
            清除所有篩選條件
          </p>
        </div>
      </div>
      <div
        class="comment_container w-[calc(100%-20rem)] py-10 lg:w-full px-10 sm:px-0"
      >
